...
const faqGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: "Is 10g niet te veel?", a: "~95% van je lichaamscreatine zit in je spieren, dus standaard 3-5g verzadigt vooral je spiermassa. Je hersenen bevatten de overige ~5%, en dat is precies wat menopauze uitput. Onderzoekers die cognitieve voordelen bij vrouwen bestuderen, gebruiken 10g of meer om de hersenen te bereiken. Ruim binnen de onderzochte veilige marges." },
      { q: "Waarom zit de creatine in de dop en niet in de vloeistof?", a: "Creatine monohydraat breekt met de tijd af in vloeistof (het wordt creatinine, een afvalstof). Door het droog te verzegelen in de dop blijft het stabiel tot het moment dat je drinkt. Twist de dop, de creatine valt in de shot, shake, en drink. Maximale potentie, geen verlies." },
      ...
      { q: "Helpt kurkuma bij menopauzeklachten?", a: "Kurkuma (curcumine) heeft ontstekingsremmende eigenschappen die relevant zijn bij menopauze-gerelateerde gewrichtsklachten (Hewlings & Kalman, 2017). Piperine (zwarte peper-extract) in de shot verhoogt de biobeschikbaarheid van curcumine met 2.000% (Shoba et al., 1998)." },
