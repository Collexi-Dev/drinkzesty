...
const faqGroups = [
  {
    ...
    items: [
      ...
      { q: "Hoeveel creatine heb je nodig per dag?", a: "3-5g per dag is voldoende voor spiervoordelen. Voor cognitieve voordelen gebruiken onderzoekers 10g of meer, omdat de hersenen hogere doseringen nodig heeft om verzadigd te raken. Bij 10g/dag zit je creatine na ~2 weken op peil." },
